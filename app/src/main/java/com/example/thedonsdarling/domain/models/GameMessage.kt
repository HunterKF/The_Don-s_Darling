...
sealed class GameMessageType(
    ...
    companion object {
        @Composable
        fun fromMessage(gameMessageType: String): LocalMessage {
            when (gameMessageType) {
                "game_round_over_winner" -> {
                    return LocalMessage(
                        longMessage = R.string.round_over_winner_message,
                        toastMessage = null
                    )
                }
                "game_round_over_tie_2_players" -> {
                    return LocalMessage(
                        longMessage = R.string.game_tie_message_2_players,
                        toastMessage = null
                    )
                }
                "game_round_over_tie_3_players" -> {
                    return LocalMessage(
                        longMessage = R.string.game_tie_message_3_players,
                        toastMessage = null
                    )
                }
                "game_round_over_tie_4_players" -> {
                    return LocalMessage(
                        longMessage = R.string.game_tie_message_4_players,
                        toastMessage = null
                    )
                }
                "game_start" -> {
                    return LocalMessage(
                        longMessage = R.string.start_game_announcement_message,
                        toastMessage = R.string.start_game_announcement_toast
                ...
                "game_over" -> {
                    return LocalMessage(
                        longMessage = R.string.game_over_winner_message,
                        toastMessage = null
                    )
                }
                "game_new_round" -> {
                    return LocalMessage(
                        longMessage = R.string.new_round_message,
                        toastMessage = R.string.new_round_message
                ...
                "card_police_correct" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_policemen_message_correct,
                        toastMessage = R.string.card_policemen_toast_message_correct
                    )
                }
                "card_private_eye" -> {
                    /*Todo - This is special and won't work this way.*/
                ...
                "card_money_lender_p1_wins" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_moneylender_message_win,
                        toastMessage = R.string.card_moneylender_toast_message_win
                    )
                }
                "card_money_lender_p2_wins" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_moneylender_message_lose,
                        toastMessage = R.string.card_moneylender_toast_message_lose
                    )
                }
                "card_money_lender_draw" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_moneylender_message_tie,
                        toastMessage = R.string.card_moneylender_toast_message_tie
                    )
                }
                "card_the_doctor" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_doctor_message,
                        toastMessage = R.string.card_doctor_toast_message
                    )
                }
                "card_the_doctor_protected" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_doctor_protection_message,
                        toastMessage = R.string.card_doctor_protection_toast_message
                    )
                }
                "card_wise_guy_forced_to_discard" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_wiseguy_message,
                        toastMessage = R.string.card_wiseguy_toast_message
                    )
                }
                "card_wise_guy_forced_to_discard_darling" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_darling_forced_message,
                        toastMessage = R.string.card_darling_forced_toast_message
                    )
                }
                "card_wise_guy_forced_to_discard_empty_deck" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_wiseguy_message_empty_deck,
                        toastMessage = R.string.card_wiseguy_toast_message_empty_deck
                    )
                }
                "card_the_don" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_the_don_message,
                        toastMessage = R.string.card_the_don_toast_message
                    )
                }
                "card_courtesan" -> {
                    /*Todo - This is special and won't work this way.*/
                ...
                "card_darling" -> {
                    /*Todo - This is special and won't work this way.*/
                    return LocalMessage(
                        longMessage = R.string.card_darling_message,
                        toastMessage = R.string.card_darling_toast_message
                    )
                }
                else -> {
                    return LocalMessage(
                        longMessage = R.string.unknown_error,
                        toastMessage = null
                    )
                }
